...
export const ERROR_MESSAGES = {
  ...
  CODE_EXECUTION_INVALID_CONFIG: '코드 실행 설정이 올바르지 않습니다',
  CODE_EXECUTION_ALREADY_INITIALIZED: '이미 초기화된 실행입니다',
  CODE_EXECUTION_INIT_TIMEOUT: '초기화 시간이 초과되었습니다',
  CODE_EXECUTION_ERROR: '코드 실행 중 오류가 발생했습니다',
  CODE_EXECUTION_NOT_INITIALIZED: '초기화되지 않은 실행입니다',
  CODE_EXECUTION_INVALID_STREAM: 'stdin에만 쓸 수 있습니다',
  CODE_EXECUTION_INVALID_SIGNAL: '유효하지 않은 신호입니다',
  ...
  ROOM_LIMIT_EXCEEDED:
    '현재 이용자가 많아 일시적으로 방 생성이 제한되었습니다. 잠시 후 다시 시도해주세요.',
} as const;

export const VALIDATION_MESSAGES = {
  NICKNAME_REQUIRED: '닉네임을 입력해주세요.',
  NICKNAME_TOO_LONG: `닉네임은 최대 ${LIMITS.NICKNAME_MAX}자까지 입력 가능합니다.`,
  ROOM_CODE_REQUIRED: '방 코드가 없습니다. 올바른 링크로 접속해주세요.',
  ...
  TOKEN_REQUIRED: '접속 정보가 올바르지 않습니다. 링크를 다시 확인해주세요.',
