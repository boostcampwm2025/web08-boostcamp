...
export default function HomePage() {
  return (
    <main className="bg-primary-foreground relative flex min-h-screen flex-col">
      <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] mask-[radial-gradient(ellipse_80%_80%_at_50%_20%,#000_60%,transparent_100%)] bg-size-[20px_20px] dark:bg-[radial-gradient(#3f3f46_1px,transparent_1px)]" />
      ...
      {/* Footer */}
      <footer className="border-border text-muted-foreground mt-24 border-t py-8 text-center font-mono text-xs">
        <p>
