...
export function ActionCard({
  ...
  return (
    <Card
      className={`group relative overflow-hidden rounded-[2rem] border border-gray-100 bg-white shadow-lg ring-0 shadow-gray-200/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-gray-200/50 ${colors.hoverBorderColor} `}
    >
      <div
      ...
      <CardHeader className="relative z-10 flex flex-col items-center gap-6 pt-12 pb-2 text-center">
        <div
          className={`flex h-12 w-12 items-center justify-center rounded-3xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 ${colors.iconBg} shadow-inner ring-1 ring-black/5`}
        >
